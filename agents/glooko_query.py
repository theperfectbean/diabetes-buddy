...
class GlookoQueryAgent:
    ...
    def process_query(self, question: str) -> QueryResult:
        ...
        # Step 4: Format response with context
...
- "when do I", "which days", "which hours" = pattern analysis"""
    ...
    def _query_glucose(self, metrics: Dict, intent: QueryIntent, 
        ...
        answer = f"Your average glucose was {avg_glucose:.0f} mg/dL ({avg_glucose/18:.1f} mmol/L)"
        ...
        return QueryResult(
            ...
            context=f"Standard deviation: {std_dev:.0f}, CV: {cv:.1f}%"
        )
